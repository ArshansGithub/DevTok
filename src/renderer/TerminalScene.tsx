        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <span style={{ fontFamily: STYLE.fonts.mono, fontSize: 13, color: '#8B949E', marginLeft: 8 }}>
                        terminal
                    </span>
                </div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        {cursorVisible && (
                            <span style={{
                                ...
                                background: '#E6EDF3', marginLeft: 1, verticalAlign: 'middle',
                            }} />
                        )}
                    </div>
                    {data.output && (
                        <div style={{
                            marginTop: 12, color: '#8B949E', whiteSpace: 'pre-wrap',
                            opacity: outputOpacity, overflowWrap: 'break-word',
                        }}>
                            {data.output}
                        </div>
                    )}
                ...
                {data.caption && (
                    <div style={{
                        ...
                        fontSize: 18, color: '#8B949E', fontStyle: 'italic',

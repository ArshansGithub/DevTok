...
export const CodeHighlightScene: React.FC<{
    ...
    const glowIntensity = interpolate(Math.sin(frame * 0.15), [-1, 1], [0.3, 0.7]);
                ...
                <div style={{ padding: '16px 0', fontFamily: STYLE.fonts.mono, fontSize: 18, lineHeight: 1.7 }}>
                    {lines.map((line, i) => {
                        ...
                        return (
                            <div key={i} style={{
                                padding: '1px 20px',
                                background: isHighlighted ? `rgba(129, 140, 248, ${glowIntensity * 0.2})` : 'transparent',
                                borderLeft: isHighlighted ? `3px solid ${STYLE.colors.accent}` : '3px solid transparent',
                                ...
                                <span style={{
                                    ...
                                    flexShrink: 0, fontWeight: isHighlighted ? 700 : 400,
                                }}>
                                    {lineNum}
                                </span>
